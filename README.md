...
Решение выполнялось по критериям на оценку 9.
...
Запускаются два садовника и карта, которые представлены в виде трех процессов. Процесс, ответственный за создание карты создает создает общие ресурсы. Удалением общих ресурсов также занимается карта. Во многом программа напоминает prog_8, но обмен данными ведется через очереди сообщений в стандарте UNIX SYSTEM V.

Результат работы при запуске программы с параметрами `2 2 2:
